...
from authy.views import UserProfile, follow, followlist, followinglist
...
urlpatterns = [
    ...
    path('<username>/followers', followlist, name='profile_followers'),
    path('<username>/followings', followinglist, name='profile_followings'),
